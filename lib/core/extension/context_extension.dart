...
extension ContextExtension on BuildContext {
  ...
  toReplacementNamed(String routeName, {Object? arguments}) =>
      Navigator.of(this).pushReplacementNamed(routeName, arguments: arguments);
  pop() => Navigator.of(this).pop();
  popUntilRoot() => Navigator.of(this).popUntil((route) => route.isFirst);
  popUntil(String routeName) => Navigator.of(this).popUntil(ModalRoute.withName(routeName));
}
